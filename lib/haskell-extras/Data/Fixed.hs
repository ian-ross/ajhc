...
instance (Eq a, Ord a, HasResolution a) => Num (Fixed a) where
...
instance (Eq a, Ord a, HasResolution a) => Real (Fixed a) where
    toRational fa@(MkFixed a) = (toRational a) / (toRational (resolution fa))

instance (Eq a, Ord a, HasResolution a) => Fractional (Fixed a) where
...
instance (Eq a, Ord a, HasResolution a) => RealFrac (Fixed a) where
...
readsFixed :: (Eq a, Ord a, HasResolution a) => ReadS (Fixed a)
...
instance (Eq a, Ord a, HasResolution a) => Show (Fixed a) where
    show = showFixed False

instance (Eq a, Ord a, HasResolution a) => Read (Fixed a) where
    readsPrec _ = readsFixed

data E0 = E0 deriving (Eq, Ord)
instance HasResolution E0 where
    resolution _ = 1
-- | resolution of 1, this works the same as Integer
type Uni = Fixed E0

data E1 = E1 deriving (Eq, Ord)
instance HasResolution E1 where
    resolution _ = 10
-- | resolution of 10^-1 = .1
type Deci = Fixed E1

data E2 = E2 deriving (Eq, Ord)
instance HasResolution E2 where
    resolution _ = 100
-- | resolution of 10^-2 = .01, useful for many monetary currencies
type Centi = Fixed E2

data E3 = E3 deriving (Eq, Ord)
instance HasResolution E3 where
    resolution _ = 1000
-- | resolution of 10^-3 = .001
type Milli = Fixed E3

data E6 = E6 deriving (Eq, Ord)
instance HasResolution E6 where
    resolution _ = 1000000
-- | resolution of 10^-6 = .000001
type Micro = Fixed E6

data E9 = E9 deriving (Eq, Ord)
instance HasResolution E9 where
    resolution _ = 1000000000
-- | resolution of 10^-9 = .000000001
type Nano = Fixed E9

data E12 = E12 deriving (Eq, Ord)
